...
| **1 · Poda do TS legado** (banco ainda intacto) | Um PR `refactor/remove-*` por passo da seção F | `rg "features/(meta\|patients\|deals\|board\|pipelines\|appointments\|followups\|financeiro\|dashboard)" src` vazio; o chat uazapi recebe e envia | 4–5 |
